...
def parse_args():
    ...
    p.add_argument("--zarr-clevel", type=int, default=None,
                   help="Blosc compression level (1-9). Default: platform auto "
                        "(1 on Linux with lz4, 3 with zstd fallback).")
