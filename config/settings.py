...
LATENCY = {
    ...
    "fast_latency_ms": 2.0,
    "slow_latency_ms": 5.0,
    "switch_threshold_mult": 2.0,  # Use fast if ATR > 2x avg
...
LIVE_RISK = {
    ...
    "session_limits": {
        "asia": {
            "max_lots": 1.0,
            "max_open_trades": 3,
            "hours_local": (time(9, 0), time(18, 0)),
            "tz": ZoneInfo("Asia/Tokyo"),
        },
        "london": {
            "max_lots": 3.0,
            "max_open_trades": 5,
            "hours_local": (time(8, 0), time(16, 30)),
            "tz": ZoneInfo("Europe/London"),
        },
        "ny": {
            "max_lots": 3.0,
            "max_open_trades": 5,
            "hours_local": (time(9, 30), time(16, 0)),
...
EXECUTION = {
    ...
    # effective_cost = base_cost x (1 + vol_alpha x max(0, vol_ratio - 1)
    #                               + liq_alpha x max(0, spread_ratio - 1))
