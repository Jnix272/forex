"""
lineage/provenance.py - dataset/model provenance records and decision trails.

Ported from ``audit/lineage.py`` (now a deprecated shim). Standard-library
only so it runs in CI / recovery shells without heavy deps.
"""
