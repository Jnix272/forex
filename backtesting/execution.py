...
from backtesting.backtest import ForexScalingBacktest, Trade, ScalingAction
from backtesting.improvements import SlippageCalibrator, LockboxTest
...
class SlippageDecomposition:
    ...
    def from_execution(cls,
                       ...
                       adverse_selection_model: Optional['AdverseSelectionModel'] = None,
...
class AdvancedExecutionEngine:
    ...
    def __init__(
        ...
        adverse_selection: Optional[AdverseSelectionModel] = None,
        slippage_calibrator: Optional[SlippageCalibrator] = None,
        tick_size: float = 0.0001,
        lot_size: float = 1.0,
    ...
    def submit_order(
        ...
        self.submit_order(Order(order_id=0, symbol=symbol, side=side, order_type=order_type,
    ...
    def get_fills(self, order_id: Optional[int] = None) -> List[Fill]:
        if order_id is None:
            return self.fills
