...
def main():
    ...
    parser.add_argument("--symbols", nargs="+", default=list(CROSS_ASSET_SYMBOLS.keys()),
    ...
    parser.add_argument("--api-key", default=os.getenv("EODHD_API_KEY"),
                        help="EODHD API key (or set EODHD_API_KEY env var)")
    parser.add_argument("--cache-dir", default="data/raw/cross_asset",
    ...
    print(f"{'='*60}")
    print(f"DOWNLOAD CROSS-ASSET DATA (EODHD)")
    print(f"{'='*60}")
