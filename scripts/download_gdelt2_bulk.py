    ...
    try:
        ...
        with zipfile.ZipFile(io.BytesIO(resp.content)) as z:
            ...
            with z.open(csv_name) as f:
                ...
                df_subset = df[
                    [COL_SQLDATE, COL_ACTOR1_COUNTRY, COL_ACTOR2_COUNTRY, COL_AVG_TONE, COL_SOURCEURL]
                ].copy()
...
def main():
    ...
    print(
        "Note: The 'headline' column is intentionally left blank. You can merge this file into historical_news_combined.parquet."
    )
