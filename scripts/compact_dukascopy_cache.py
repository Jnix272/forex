...
def main():
    ...
    try:
        ...
        import subprocess
        raw_size = subprocess.run(
            ["du", "-sh", "data/raw/dukascopy"], capture_output=True, text=True
        ).stdout.strip()
