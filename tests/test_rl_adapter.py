...
class TestGymEnvWrapper:
    ...
    def test_wrapper_reset_step(self, mock_env):
        ...
        obs, reward, terminated, truncated, info = wrapper.step(0)  # noqa: RUF059
        ...
        # Step until done
        for _ in range(2):
            obs, reward, terminated, truncated, _info = wrapper.step(0)
...
class TestFactoryFunction:
    ...
    def test_create_cleanrl(self):
        from training.rl_adapter import CleanRLAdapter, RLConfig, create_rl_adapter
    ...
    def test_create_sb3(self):
        from training.rl_adapter import RLConfig, SB3Adapter, create_rl_adapter
    ...
    def test_create_custom(self):
        from training.rl_adapter import CustomRLAdapter, RLConfig, create_rl_adapter
    ...
    def test_create_invalid_framework(self):
        from training.rl_adapter import RLConfig, create_rl_adapter
