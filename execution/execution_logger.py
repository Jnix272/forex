...
class ExecutionLogger:
    ...
    def log_signal(self, pair: str, direction: str, confidence: float,
                   model_name: str = "", features_hash: str = ""):
        self._write({
            "event": "SIGNAL",
            "pair": pair,
            "direction": direction,
    ...
    def log_order(self, order_id: str, pair: str, side: str, size: float,
    ...
    def log_fill(self, order_id: str, fill_price: float, slippage_pips: float,
                 fill_size: float = 0.0):
        self._write({
            "event": "ORDER_FILLED",
            "order_id": order_id,
    ...
    def log_trade_close(self, order_id: str, entry_price: float,
