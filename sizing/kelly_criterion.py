...
def square_root_impact(
    ...
    """Market impact (pips) = coef x sqrt(size/ADV)."""
...
class PositionSizer:
    ...
    def __init__(self, equity=10_000, kelly_fraction=0.25, max_position_pct=0.05, target_vol=0.10, pip_risk=20.0):
        self.equity = equity
    ...
    def size_position(self, win_prob, win_loss_ratio, returns, price, current_atr, lot_size=10_000):
